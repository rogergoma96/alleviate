...
const AirBnbDesktop = () => {
  ...
  return (
    <SectionContainerMobile
      id="AirBnB"
      imgUrl="/images/img-mobile-04.jpg"
    ...
    >
      ...
      <p className={`text-body ${styles.description}`}>
        We heighten this experience by providing clients with organized
        utensils, plentiful toiletries, and a spotless home every time.
      </p>
      <Dropdown label="Kitchen">
        <p className="text-body">
          Clean the stove, fridge, toaster, kettle, and all other small and
          large appliances.
        </p>
