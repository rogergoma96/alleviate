  ...
  <section id="FAQs" className={styles.container}>
    ...
    <Dropdown label="How do I pay?" className="text-title-s">
      <p className={`text-body ${styles.answer}`}>
        ...
        address. We also offer a card option. We will send you an invoice with a
        link to “square” which is a trustworthy source to enter your card
        information and directly pay for our services.
      </p>
    </Dropdown>
    <div className={styles.separator} />
    <Dropdown
