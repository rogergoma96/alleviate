...
const HomeAndApartmentDesktop = () => (
  ...
  >
    ...
    <p className={`text-body ${styles.description}`}>
      ...
      biweekly, monthly) and deep cleaning which cleans the floor, ceiling, and
    ...
    <Dropdown label="UPKEEP CLEANING CHECKLIST">
      ...
      <p className="text-body">Clean exterior of oven, fridge, & dishwasher.</p>
    ...
    <Dropdown label="DEEP CLEANING CHECKLIST">
      ...
      <p className="text-body">Clean & sanitize trash can & change trash bag</p>
